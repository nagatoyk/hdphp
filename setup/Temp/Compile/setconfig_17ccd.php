...
<body>
    ...
    <form method="post" name="form1" id="form1" action="<?php echo U(updateconfig);?>">
        <div class="setup">
            <dl>
                <dt>配置数据库</dt>
                <dd>
                    <table>
                        <tr>
                            ...
                            <td><input type="text" value="<?php echo $field['db_host'];?>" name="dbhost" id="dbhost"/></td>
                        </tr>
                        <tr>
                            <td width="200">数据库连接端口</td>
                            <td><input type="text" name="dbport" id="dbport" value="<?php echo $field['db_port'];?>"/></td>
                        </tr>
                        <tr>
                            <td width="200">数据库用户名<b>*</b></td>
                            <td><input type="text" name="dbuser" id="dbuser" value="<?php echo $field['db_user'];?>"/></td></tr>
                        <tr>
                            <td width="200">数据库密码</td>
                            <td><input type="text" name="dbpwd" id="dbpwd" value="<?php echo $field['db_password'];?>"/></td>
                        </tr>
                        <tr>
                            <td width="200">数据库名称<b>*</b></td>
                            <td><input type="text" name="dbname" id="dbname" value="<?php echo $field['db_database'];?>"/></td>
                        </tr>
                        <tr>
                            <td width="200">表前缀</td>
                            <td><input type="text" name="dbfix" id="tbfix" value="<?php echo $field['db_prefix'];?>"/></td>
                        </tr>
                        <tr>
                            <td  colspan="2">
